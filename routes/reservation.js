...
Bike.findById(bikeID, function (err, result) {
  ...
  ",\n Thank you for booking your upcoming adventure with us!  When you come to pick up the bike we'll work with you to setup such things like fit, suspension settings and adjustments, tire pressure, and run you through the controls to make sure you're comfortable before you get shredding!"+
  ...
  "\n And remember, if you happen to purchase a bike from us within 30 days of the rental, we'll deduct the cost of the rental off of your total."+
  "\n Thank you again for booking with us.  We're looking forward to getting you out on the trails!"+
  "\n Ride on,"+
  "\n ACF"
